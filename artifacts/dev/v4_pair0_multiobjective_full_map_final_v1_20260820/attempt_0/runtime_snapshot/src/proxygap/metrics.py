...
CSV_SCHEMA = [
    ...
    "foot_landing_active_count_sum",
    "foot_landing_active_count_by_foot",
    "foot_lateral_velocity_shaping_weight",
    "foot_lateral_velocity_shaping_scale",
    "reward_foot_lateral_velocity_shaping_sum",
    "foot_lateral_velocity_penalty_sum",
    "foot_lateral_velocity_penalty_sum_by_foot",
    "foot_vertical_velocity_shaping_weight",
    "foot_vertical_velocity_shaping_scale",
    "reward_foot_vertical_velocity_shaping_sum",
    "foot_vertical_velocity_penalty_sum",
    "foot_vertical_velocity_penalty_sum_by_foot",
